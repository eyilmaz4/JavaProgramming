...
public class SurveyPrepairing {
    public List<SurveyQuestions> prepSurvey(int number) {
    ...
    public void startSurvey(List<SurveyQuestions>survey){
        ...
        for(SurveyQuestions sr:survey){
            ...
            System.out.println(sr.getOption1()+"\t");
            System.out.println(sr.getOption2()+"\t");
            System.out.println(sr.getOption3()+"\t");
